...
const TYPING_TEXTS = [
  ...
  'Clean APIs. Robust systems.',
];

export default function Hero() {
  const typedText = useTypingAnimation(TYPING_TEXTS, 70, 35, 2200);
        ...
        <div className={styles.heroGrid}>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.name}>
              Agrim <span>Bhardwaj</span>
            </h1>
            <p className={styles.titleLine}>
              Software Developer | <span className={styles.typingText}>{typedText}</span>
            </p>
            <p className={styles.tagline}>
              Backend-first developer who ships performant systems, clean APIs,
              and solves hard problems under pressure.
            </p>

            <div className={styles.heroCtas}>
              <button className={styles.btnPrimary} onClick={scrollToProjects} id="cta-projects">
          ...
          <div className={styles.heroVisual}>
            ...
            <div className={`${styles.floatingSymbol} ${styles.symbol1}`}>{"</>"}</div>
            <div className={`${styles.floatingSymbol} ${styles.symbol2}`}>{"{ }"}</div>
            <div className={`${styles.floatingSymbol} ${styles.symbol3}`}>{"01"}</div>
            <div className={`${styles.floatingSymbol} ${styles.symbol4}`}>{"$"}</div>
            ...
            <div className={styles.codeBlock}>
              ...
              <code>
                ...
                <span className={styles.codeConst}>developer</span>{' '}
                <span className={styles.codePunct}>= {'{'}</span><br />
                {'  '}<span className={styles.codeConst}>name</span><span className={styles.codePunct}>:</span>{' '}
                <span className={styles.codeString}>"Agrim Bhardwaj"</span><span className={styles.codePunct}>,</span><br />
                {'  '}<span className={styles.codeConst}>role</span><span className={styles.codePunct}>:</span>{' '}
                <span className={styles.codeString}>"Software Dev"</span><span className={styles.codePunct}>,</span><br />
                {'  '}<span className={styles.codeConst}>skills</span><span className={styles.codePunct}>:</span>{' '}
                <span className={styles.codePunct}>[</span>
                <span className={styles.codeString}>"C++"</span><span className={styles.codePunct}>,</span>{' '}
                <span className={styles.codeString}>"Java"</span><span className={styles.codePunct}>,</span>{' '}
                <span className={styles.codeString}>"React"</span>
                <span className={styles.codePunct}>]</span><span className={styles.codePunct}>,</span><br />
                {'  '}<span className={styles.codeConst}>passion</span><span className={styles.codePunct}>:</span>{' '}
                <span className={styles.codeString}>"Competitive Prog"</span><span className={styles.codePunct}>,</span><br />
                {'  '}<span className={styles.codeConst}>available</span><span className={styles.codePunct}>:</span>{' '}
                <span className={styles.codeKeyword}>true</span><br />
                <span className={styles.codePunct}>{'}'}</span><span className={styles.codePunct}>;</span><br />
                <br />
                <span className={styles.codeComment}>{'// Let\'s build something great!'}</span>
              </code>
            </div>
          </div>
        </div>
